...
"""
    ...
    try:
        ...
        print(fAn error occurred while fetching sales follows: {e})
        return None
...
""""""
    ...
    "
    try:
        follow = api_client.post(/ales"-follows/, json=follow_data")
        return follow
    except Exception as e:
        print(fAn error occurred while creating a sales follow: {e}"")
        return None