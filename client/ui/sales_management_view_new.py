...
class SalesManagementView(QWidget):
    ...
    def setup_search_toolbar(self):
        ...
        self.customer_manager_combo.setPlaceholderText("客户意向")
        ...
        # 设置当前索引为-1以显示占位符
        self.customer_manager_combo.setCurrentIndex(-1)
    ...
    def setup_table(self):
        ...
        headers = [
            ...
            "客户意向", "联系记录", "订单", "下次预约时间", "销售人", "更新时间", "操作"
        ]
        ...
        header.setSectionResizeMode(6, QHeaderView.ResizeMode.ResizeToContents)  # 客户意向 - 自适应内容
        header.setSectionResizeMode(7, QHeaderView.ResizeMode.Interactive)  # 联系记录 - 可交互调整
        header.setSectionResizeMode(8, QHeaderView.ResizeMode.Fixed)  # 订单 - 固定
        header.setSectionResizeMode(9, QHeaderView.ResizeMode.ResizeToContents)  # 下次预约时间 - 自适应内容
        header.setSectionResizeMode(10, QHeaderView.ResizeMode.ResizeToContents)  # 销售人 - 自适应内容
        ...
        self.table_view.setColumnWidth(8, 60)   # 订单
    ...
    def update_table_view(self):
        ...
        for i, customer in enumerate(self.customers_data, 1):
            ...
            items = [
                ...
                QStandardItem(customer.get("contact_status", "")),
                QStandardItem(customer.get("customer_manager", "")),
                QStandardItem(customer.get("contact_records", "")),
                QStandardItem(customer.get("score", "")),
                QStandardItem(customer.get("next_contact_time", "")),
                QStandardItem(customer.get("sales_person", "")),
                QStandardItem(customer.get("update_time", "")),
            ...
            # 设置联系状态的颜色
            contact_status = customer.get("contact_status", "")
    ...
    def on_search_clicked(self):
        ...
        # 获取搜索条件
        params = {
            'customer_unit': self.customer_unit_combo.currentData(),
        ...
        # 这里应该调用API进行搜索
        # 暂时显示提示
        show_message_box(self, "搜索", f"搜索功能正在开发中...\n搜索条件: {params}")
        ...
        if index.isValid():
            ...
            if row < len(self.customers_data):
                ...
                show_message_box(
                    ...
                    f"联系状态: {customer.get('contact_status', '')}\n"
                    f"销售人员: {customer.get('sales_person', '')}"
                )

# 导出
__all__ = ['SalesManagementView']
