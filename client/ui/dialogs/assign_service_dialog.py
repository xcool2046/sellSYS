...
class AssignServiceDialog(QDialog):
    ...
    def setup_ui(self):
        ...
        self.dept_label_value = QLabel("客服部")
        ...
        self.group_combo.addItem("客服一组", "service_group_1")
        self.group_combo.addItem("客服二组", "service_group_2")
        self.group_combo.addItem("客服三组", "service_group_3")
        ...
        self.service_combo.addItem("陈小二", "chen_xiaoer")
        self.service_combo.addItem("李小花", "li_xiaohua")
        self.service_combo.addItem("王小美", "wang_xiaomei")
        self.service_combo.addItem("赵小丽", "zhao_xiaoli")
        service_layout.addWidget(self.service_combo)
        
        form_layout.addWidget(service_row)
    ...
    def on_group_changed(self, group_name: str):
        ...
        if "一组" in group_name:
            ...
            self.service_combo.addItem("孙小雨", "sun_xiaoyu")
            self.service_combo.addItem("周小月", "zhou_xiaoyue")
    ...
    def get_assignment_data(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'service_person_id': self.service_combo.currentData()
        }

# 导出
__all__ = ['AssignServiceDialog']
