...
"""添加或编辑部门分组的对话框"""
    def __init__(self, parent=None, group=None, departments=None):
        ...
        title_label.setObjectName(abel)
        ...
        if self.is_edit_mode:
            ...
            dept_id = self.group.get(department_"id")
        ...
        self.save_button.setObjectName("tton")
    ...
    def get_data(self):
        ...
        return {
""").strip(),"""
            department_""id: self.dept_map.get(selected_dept_name)
        }
...
if __name__ == '__main__':
    ...
    if add_dialog.exec():
        print(Added d"ata":, add_dialog.get_data())

    # Test Edit Dialog
    mock_group = {"id: 1, "name: 一"组", department_"id: 1}"
